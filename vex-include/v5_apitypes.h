...
typedef struct __attribute(( packed )) _V5_DeviceImuQuaternion {
    double              a;
    double              b;
    double              c;
    double              d;
...
// Angle data from IMU
typedef struct __attribute(( packed )) _V5_DeviceImuAngles {
    double              pitch;  // x
    double              roll;   // y
    double              yaw;    // z
} V5_DeviceImuAngles;
...
// Raw data from IMU
typedef struct __attribute(( packed )) _V5_DeviceImuRaw {
    double              x;
    double              y;
    double              z;
} V5_DeviceImuRaw;
...
typedef struct __attribute__ ((packed)) _v5_image {
    uint16_t  width;
    uint16_t  height;
    uint32_t *data;
    uint32_t *p;
